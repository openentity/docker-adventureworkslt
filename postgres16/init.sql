...
FROM '/docker-entrypoint-initdb.d/SalesLT.Address.csv'
...
FROM '/docker-entrypoint-initdb.d/SalesLT.Customer.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.CustomerAddress.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.ProductCategory.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.ProductModel.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.ProductDescription.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.ProductModelProductDescription.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.Product.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.SalesOrderHeader.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
...
FROM '/docker-entrypoint-initdb.d/SalesLT.SalesOrderDetail.csv'
WITH DELIMITER ',' NULL 'NULL' CSV HEADER;
